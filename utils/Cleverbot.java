...
public class Cleverbot {
	...
	public static Cleverbot newBot() {
		return newBot(Random.genKey(128));
	}
	...
	public String askQuestion(String question) throws CommandException {
		...
		//			final Map data = Main.newHashMap(new String[] {"success", "exception"}, new Object[] {true, null});
		//			((JDAImpl) Main.getShards().get(0)).getHttpClientBuilder().build().newCall(builder.build()).enqueue(new Callback() {
		//
		//				@Override
		...
		//
		//			});
		//			final Map data1 = Main.newHashMap(new String[] {"success", "exception"}, new Object[] {true, null});
		//			((JDAImpl) Main.getShards().get(0)).getHttpClientBuilder().build().newCall(builder.build()).enqueue(new Callback() {
		//
		//				@Override
		//				public void onFailure(Call arg0, IOException arg1) {
