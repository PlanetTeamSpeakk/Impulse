...
public class MathHelper {
	...
	/**
	 * To calculate how much 25% of 6800 is use {@link com.ptsmods.impulse.Main#percentage(double, double, double) percentage(100, 6800, 25)} where only the last 2 arguments are edited.
	 * To calculate how much 4800 of 6800 is use {@link com.ptsmods.impulse.Main#percentage(double, double, double) percentage(6800, 4800, 100)} where only the first 2 arguments are edited.
	 */
	...
	public static class Percentage extends Number {
		...
		public Percentage(float value) {
			if (value > 100 || value < 0) throw new IllegalArgumentException("The given value was higher than 100 or lower than 0.");
			this.value = value;
		}
