...
public class Economy {
	...
	@Subcommand(help = "Register an account at the Impulse bank.", name = "register", parent = "com.impulsebot.commands.Economy.bank", guildOnly = true)
	...
	@Subcommand(help = "Set, add or remove credits from your or someone elses bank account.\n\nExamples:\n\t[p]bank set 6900 @PlanetTeamSpeak\n\t[p]bank set +6900 @PlanetTeamSpeak\n\t[p]bank set -6900 @PlanetTeamSpeak.", name = "set", parent = "com.impulsebot.commands.Economy.bank", arguments = "<amount> [user]", guildOnly = true, userPermissions = {Permission.ADMINISTRATOR})
	...
	@Subcommand(help = "Tells you your or someone else's balance.", name = "balance", parent = "com.impulsebot.commands.Economy.bank", arguments = "[user]", guildOnly = true)
	...
	@Subcommand(help = "Transfer balance from your account to another account.", name = "transfer", parent = "com.impulsebot.commands.Economy.bank", arguments = "<amount> <user>", guildOnly = true)
	...
	@Subcommand(help = "Resets the balance of everyone in this server.", name = "reset", parent = "com.impulsebot.commands.Economy.bank", guildOnly = true, userPermissions = {Permission.ADMINISTRATOR})
	public static void bankReset(CommandEvent event) throws IOException {
		if (bank.containsKey(event.getGuild().getId())) {
			...
			else if (!response.getContentDisplay().startsWith("ye"))
	...
	@Subcommand(help = "Set the amount of credits a user should get when using the payday command.", name = "paydaycredits", parent = "com.impulsebot.commands.Economy.economySet", arguments = "<value>", userPermissions = {Permission.ADMINISTRATOR}, guildOnly = true)
	...
	@Subcommand(help = "Set the amount of seconds a user should wait before using the payday command.", name = "paydaycooldown", parent = "com.impulsebot.commands.Economy.economySet", arguments = "<value>", userPermissions = {Permission.ADMINISTRATOR}, guildOnly = true)
	...
	@Subcommand(help = "Set the amount of seconds a user should wait before using the slot command.", name = "slotcooldown", parent = "com.impulsebot.commands.Economy.economySet", arguments = "<value>", userPermissions = {Permission.ADMINISTRATOR}, guildOnly = true)
	...
	@Subcommand(help = "Set the amount of credits a user should get when using the payday command.", name = "russianroulettecooldown", parent = "com.impulsebot.commands.Economy.economySet", arguments = "<value>", userPermissions = {Permission.ADMINISTRATOR}, guildOnly = true)
